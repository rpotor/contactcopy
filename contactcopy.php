...
<head>
    ...
    <title>Contact copy application for EVE Online</title>
</head>
<body>
...
//Get the characterID of the source character
...
if ($xml->error) {
    ...
    $uzi = "Whoops, I can't find your source character by the name you've given in the EVE universe. :-(";
	$uzi = $uzi . "<br />Click the link below to go back and try again.<br />";
...
$headers = array(
"User-Agent: contactcopy application (rpotor@gmail.com)",
"Authorization: Bearer ".$auth_code
);
...
if ($xml->error) {
    ...
    $uzi = "Whoops, seems like you have no alliance contacts on your source character. In that case I got no soup for your. :-(";
	$uzi = $uzi . "<br />Click the link below to go back and try again.<br />";
	$uzi = $uzi . '<a href="index.html">Take me back to the start.</a>';
	clearwrap();
	prettify($uzi);
...
$uzi = "Okay, everything is done, the personal contact list of your target character is now synchronized and up to date with the alliance contact list of the source character.";
$uzi = $uzi . "<br />If you want to copy the alliance contact list to another character, then click the link below to go back to the beginning. If the target character is on another account of yours, first go to an EVE Online website, for example evegate.com and log-out and then click the below link. Otherwise you can close this browser window. Fly safe! :-)<br />";
$uzi = $uzi . '<a href="index.html">Take me back to the start.</a>';
clearwrap();
prettify($uzi);
?>
